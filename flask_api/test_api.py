...
train_files = {'data_file_X': open('./data/clyq_X.csv','rb'),
	'data_file_y': open('./data/clyq_y.csv','rb'),
	'params_file': open('./params/clf_params.yaml')}
...
r_model = requests.post(model_url, data={'model_name':'testclf1'})
